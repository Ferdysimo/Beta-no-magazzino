# Dettagli backlog e progettazioni future

Stato: documento di approfondimento. La coda operativa sintetica e in
`../TODO.md`; questo file conserva requisiti, ragionamenti e test previsti.
